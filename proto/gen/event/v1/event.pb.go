...
const file_event_v1_event_proto_rawDesc = "" +
	...
	"\auser_id\x18\x06 \x01(\tR\x06userId\"\xf0\x01\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\blocation\x12?\n" +
	"\tdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\bdateTime\"\xd4\x01\n" +
	...
	"\blocation\x18\x04 \x01(\tR\blocation\x127\n" +
	"\tdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\bdateTime\x12\x17\n" +
	"\auser_id\x18\x06 \x01(\tR\x06userId\"\xc6\x01\n" +
	"\x05Event\x12\x19\n" +
	"\bevent_id\x18\x01 \x01(\tR\aeventId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1a\n" +
	"\blocation\x18\x04 \x01(\tR\blocation\x127\n" +
	"\tdate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\bdateTime\x12\x17\n" +
	"\auser_id\x18\x06 \x01(\tR\x06userId2\xa8\x03\n" +
	"\fEventService\x12`\n" +
	...
	"\bGetEvent\x12\x19.event.v1.GetEventRequest\x1a\x1a.event.v1.GetEventResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/event/{event_id}B\x91\x01\n" +
	"\fcom.event.v1B\n" +
...
var file_event_v1_event_proto_depIdxs = []int32{
	9,  // 0: event.v1.CreateEventRequest.date_time:type_name -> google.protobuf.Timestamp
	9,  // 1: event.v1.CreateEventResponse.date_time:type_name -> google.protobuf.Timestamp
	9,  // 2: event.v1.UpdateEventRequest.date_time:type_name -> google.protobuf.Timestamp
	9,  // 3: event.v1.UpdateEventResponse.date_time:type_name -> google.protobuf.Timestamp
	9,  // 4: event.v1.GetEventResponse.date_time:type_name -> google.protobuf.Timestamp
	9,  // 5: event.v1.Event.date_time:type_name -> google.protobuf.Timestamp
	0,  // 6: event.v1.EventService.CreateEvent:input_type -> event.v1.CreateEventRequest
	2,  // 7: event.v1.EventService.UpdateEvent:input_type -> event.v1.UpdateEventRequest
	4,  // 8: event.v1.EventService.DeleteEvent:input_type -> event.v1.DeleteEventRequest
	6,  // 9: event.v1.EventService.GetEvent:input_type -> event.v1.GetEventRequest
	1,  // 10: event.v1.EventService.CreateEvent:output_type -> event.v1.CreateEventResponse
	3,  // 11: event.v1.EventService.UpdateEvent:output_type -> event.v1.UpdateEventResponse
	5,  // 12: event.v1.EventService.DeleteEvent:output_type -> event.v1.DeleteEventResponse
	7,  // 13: event.v1.EventService.GetEvent:output_type -> event.v1.GetEventResponse
